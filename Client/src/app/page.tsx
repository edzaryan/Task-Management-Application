...
function Home() {
  ...
  return (
      <main>
        ...
        {/*    <img src={photo} alt={name} className="w-[40px] h-[40px] rounded-full" />*/}
        {/*    {!isVerified && (*/}
        {/*      <button className="px-4 py-2 bg-blue-500 text-white rounded-md" onClick={emailVerification}>Verify Account</button>*/}
        {/*    )}*/}
        {/*    <button className="px-4 py-2 bg-red-600 text-white rounded-md" onClick={logoutUser}>Logout</button>*/}
        {/*  </div>*/}
        {/*</Header>*/}
        {/*<section>*/}
        ...
        {/*          (user: any, i: number) =>*/}
        {/*            user.role !== "admin" && (*/}
        {/*              <li key={i} className="mb-2 px-2 py-3 border grid grid-cols-4 items-center gap-8 rounded-md">*/}
